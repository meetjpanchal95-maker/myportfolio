  ...
  return (
    ...
    <section key="faq" className="flex flex-col gap-4 text-left">
      ...
      <div className="rounded-[18px] border border-[var(--color-text-accent)] bg-[color:color-mix(in_srgb,var(--color-main-bg)_88%,var(--color-page-bg))] px-5 py-4">
        ...
        <p className="mt-2 font-montserrat text-[0.96rem] leading-7 text-theme-text/85">Varun Chakravarthy began pursuing professional cricket seriously around 2017 to 2018 and had his IPL breakthrough in 2020 with KKR.</p>
      </div>
      <div className="rounded-[18px] border border-[var(--color-text-accent)] bg-[color:color-mix(in_srgb,var(--color-main-bg)_88%,var(--color-page-bg))] px-5 py-4">
...
export default function C1CPage() {
  return <ThreadPageShell threadSlug="C2C" articleBody={threadArticleBody} featuredMedia={threadFeaturedMedia} sidebarContent={threadSidebarContent} />;
}
